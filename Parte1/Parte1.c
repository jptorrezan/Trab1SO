...
int main(){
  int continuar=1;
    do
    {
        printf("\n\t\t===Menu===\n\n");
        printf("\t1. Arquivos\n");
        printf("\t2. Gerenciamento de processos\n");
        printf("\t3. Gerenciamento de Memoria\n");
        printf("\t0. Sair\n");
        ...
        {
            case 1:
                if(gerenciamentoArquivos() < 0){
                  printf("A manipulação de arquivos apresentou erro, cheque se o arquivo 'HelloWorld.txt' está no diretório.\n" );
                }
                break;

            case 3:
                if(gerenciamentoMemoria() < 0){
                  printf("Programa será exitado\n" );
                  return -1;
                }
                break;
